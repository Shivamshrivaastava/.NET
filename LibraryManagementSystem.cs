...
class Library
{
    ...
    public void BorrowBook(int userID, int bookID)
    {
        ...
        {
            Console.WriteLine("Book is not available or user/book not found.");
        }
    }
...
class Program
{
    static void Main()
    {
        ...
        // Adding books
        library.AddBook(new Book(101, "C# Basics", "John Doe"));
        library.AddBook(new Book(102, "Advanced C#", "Jane Smith"));
        
        // Adding users
        library.AddUser(new User(1, "Alice"));
        library.AddUser(new PremiumUser(2, "Bob", "Gold"));
        
        // Borrowing and returning books
        library.BorrowBook(1, 101);
        library.Books[0].DisplayBookDetails(true);
